   ...
   return (
      <>
         ...
         <aside
            ref={menuDesktopRef}
            className={
               "gsap-projects-menu-page hidden lg:flex fixed w-36 top-24 right-2 bottom-0 flex-col gap-4 overflow-y-scroll overflow-x-visible z-10 opacity-0 lg:opacity-100 border-l border-faded py-4 pl-4 bg-primary"
            }
         >
            {projectsData?.map((project: PortfolioItem, index) => {
               return (
